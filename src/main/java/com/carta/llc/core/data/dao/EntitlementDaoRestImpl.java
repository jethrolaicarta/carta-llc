 ...
 */
@Repository
public class EntitlementDaoRestImpl implements EntitlementDao<Entitlement> {

	private static final String ENTITLEMENT_TABLE_NAME = "entitlement";
	final private Logger logger = LoggerFactory.getLogger(EntitlementDaoRestImpl.class);
